 ...
 */
public final class Request { // TODO add parameter type?
    ...
    private Request(Principal principal, Collection<Id> ids, Collection<String> attributes, Map<String, Object> attributesValues) {
    ...
    public static Request read(Principal principal, Collection<Id> ids, Collection<String> attributes) {
        return new Request(principal, ids, attributes, Collections.emptyMap());
    }

    public static Request delete(Principal principal, Collection<Id> ids, Collection<String> attributes) {
        return new Request(principal, ids, attributes, Collections.emptyMap());
    }

    public static Request write(Principal principal, Collection<Id> ids, Map<String, Object> attributesValues) {
        return new Request(principal, ids, attributesValues.keySet(), attributesValues);
    }

    public static Request create(Principal principal, Map<String, Object> attributesValues) {
        return new Request(principal, Collections.emptyList(), attributesValues.keySet(), attributesValues);
    }

    public static Request search(Principal principal, Map<String, Object> attributesValues) {
        return new Request(principal, Collections.emptyList(), attributesValues.keySet(), attributesValues);
    }
